...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tonCollapse: zTreeOnCollapse\r\n");
      out.write("\t\t}\r\n");
      out.write("\t};\r\n");
      out.write("\t\r\n");
      out.write("\tvar zNodes ={name: \"地区节点\", id:1};\r\n");
      out.write("\t\r\n");
      out.write("\t$.fn.zTree.init($(\"#treeDemo\"), setting, zNodes);\r\n");
      out.write("\t\r\n");
      out.write("\ttreeObj = $.fn.zTree.getZTreeObj(\"treeDemo\");\r\n");
      out.write("\tvar newNode = \"\";\r\n");
      out.write("\tvar nodes = treeObj.getNodes();\r\n");
      out.write("\t\r\n");
      out.write("\t$.ajax({  \r\n");
      ...
      out.write("        url: \"/region/doGetTreeRegion\",//请求的action路径  \r\n");
      out.write("        error: function () {//请求失败处理函数  \r\n");
      out.write("            alert('请求失败');  \r\n");
      out.write("        },  \r\n");
      out.write("        success:function(data){ //请求成功后处理函数。    \r\n");
      out.write("        \tnewNode = data;   //把后台封装好的简单Json格式赋给treeNodes  \r\n");
      out.write("        }  \r\n");
      out.write("    });\r\n");
      out.write("\ttreeObj.addNodes(nodes[0], newNode);\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("\tfunction zTreeOnExpand(event, treeId, treeNode) {\r\n");
      out.write("\t\tvar newNode1 = \"\";\r\n");
      out.write("\t    $.ajax({  \r\n");
      out.write("\t        async : false,  \r\n");
      out.write("\t        cache:false,  \r\n");
      ...
      out.write("\t        },  \r\n");
      out.write("\t        success:function(data){ //请求成功后处理函数。    \r\n");
      out.write("\t        \tnewNode1 = data;   //把后台封装好的简单Json格式赋给treeNodes  \r\n");
      out.write("\t        }  \r\n");
      out.write("\t    });\r\n");
      out.write("\t    treeObj.removeChildNodes(treeNode);\r\n");
      out.write("\t    treeObj.addNodes(treeNode, newNode1);\r\n");
      out.write("\t};\r\n");
      out.write("\t \r\n");
      out.write("\tfunction zTreeOnCollapse(event, treeId, treeNode) {\r\n");
      out.write("\t\ttreeObj.removeChildNodes(treeNode);\r\n");
      out.write("\t};\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t        data:{'id':treeNode.id},\r\n");
      out.write("\t\t        dataType : \"json\",  \r\n");
      out.write("\t\t        url: \"/region/doGetOneRegion\",//请求的action路径  \r\n");
      out.write("\t\t        error: function () {//请求失败处理函数  \r\n");
      out.write("\t\t            alert('请求失败');  \r\n");
      out.write("\t\t        },  \r\n");
      out.write("\t\t        success:function(data){ //请求成功后处理函数。    \r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tform1.action=\"/region/add\";\r\n");
      ...
      out.write("\t\tif (!forms.validate().form()) return false;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tform1.action=\"/region/edit\";\r\n");
      out.write("\t\tform1.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tform1.action=\"/region/delete\";\r\n");
      out.write("\t\tform1.submit();\r\n");
      out.write("\t}\r\n");
      out.write("</SCRIPT>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t\t\t\t    \t\t<label class=\"control-label\" for=\"name\">地区名称</label>\r\n");
      ...
      out.write("\t\t\t\t\t\t  \t<div class=\"row-fluid\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group span12\">\r\n");
      out.write("\t\t\t\t\t\t    \t\t<label class=\"control-label\" for=\"code\">地区编码</label>\r\n");
      out.write("\t\t\t\t\t\t    \t\t<div class=\"controls\">\r\n");
      ...
      out.write("\t\t\t\t\t      \t\t<button class=\"btn btn-info\" type=\"button\" onclick=\"remove()\"><i class=\"icon-remove\"></i> 删除本级</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
